...
/**
 * 데이터ㅔ이스 접속 테스트 클래스
 * 1. JDBC 드라이버 로딩 : Class.forName("orcal.jdbc.OracleDriver");
 * 2. 접속 정보 설정 : DriverManager.getConnection("jdbc:oracle:thin:@locarlhost:1521:orcl". "scholl", "1234");
 */
public class DepartmentDBConnect {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // JDBC 드라이버가 있어야 자바 프로그램에서 오라클 데이터베이스에 접속할 수 있음
            // 오라클 드라이버를 로딩하면 JDBC 드라이버가 DriverManger에 등록됨.
